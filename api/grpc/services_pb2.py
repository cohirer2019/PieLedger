...
_SPLITQUERYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='from_datetime', full_name='pieledger.SplitQueryRequest.from_datetime', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='to_datetime', full_name='pieledger.SplitQueryRequest.to_datetime', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='account', full_name='pieledger.SplitQueryRequest.account', index=4,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='account_name', full_name='pieledger.SplitQueryRequest.account_name', index=7,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='transref', full_name='pieledger.SplitQueryRequest.transref', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='guid', full_name='pieledger.SplitQueryRequest.guid', index=9,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='inverse_acc_id', full_name='pieledger.SplitQueryRequest.inverse_acc_id', index=10,
