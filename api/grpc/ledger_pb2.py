...
_SPLIT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='inverse', full_name='pieledger.Split.inverse', index=9,
...
_SPLIT.fields_by_name['inverse'].message_type = _SPLIT
