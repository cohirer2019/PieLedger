...
_SPLITACTION = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='C', index=16, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CONFER', index=17, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='H', index=18, number=9,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SHARE', index=19, number=9,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='P', index=20, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROFIT', index=21, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='L', index=22, number=11,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CANCEL', index=23, number=11,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='Y', index=24, number=12,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PREPAY', index=25, number=12,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_SPLIT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='inverses', full_name='pieledger.Split.inverses', index=9,
...
_SPLIT.fields_by_name['inverses'].message_type = _SPLIT
